    ...
    <div class="box">
      <div class="book_sort">
        <div class="tab">
          ...
          <div v-for="sort in sortList" class="tab_list" :key="sort.id">
  ...
  export default {
    ...
    methods: {
      ...
      addBookToCart(id) {
        ...
        reqAddCart(this.$store.getters.getUser.username, id, 1).then(response => {
          if (response.code == 200) {
            this.$message({
    ...
    created() {
      ...
      let sortNameList = this.sortName.split("/")
      this.getSortList();
