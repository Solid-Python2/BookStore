...
export const reqDelFirstSort = (sortName)=>ajax(BASE_URL+'/delFirstSort/',{sortName},'DELETE')
export const reqDelSecondSort = (upperName,sortName)=>ajax(BASE_URL+'/delSecondSort/',{upperName,sortName},'DELETE')
