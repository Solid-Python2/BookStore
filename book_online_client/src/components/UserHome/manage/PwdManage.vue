        ...
        methods: {
            submitForm(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        console.log("=====this.ruleForm.oldPassword:========"+this.ruleForm.oldPassword+"====")
                        //数据校验成功，可以进行提交操作
                        reqModUserPwd(this.$store.getters.getUser.username,this.ruleForm.oldPassword,this.ruleForm.newPassword).then((response)=>{
