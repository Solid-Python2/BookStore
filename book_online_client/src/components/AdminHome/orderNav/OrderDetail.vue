  ...
  <div class="content">
    <div class="step">
      <el-steps :active="active" finish-status="success" align-center>
        <el-step title="已付款" :description="dateFormat(order.orderTime)"></el-step>
    ...
    <div class="info">
      ...
      <div class="table-layout">
        ...
        <el-row>
          ...
          <el-col :span="5" class="table-cell">{{dateFormat(order.orderTime)}}</el-col>
        </el-row>
      </div>
...
<script>
  import {reqAdminGetOrderDetail,reqAdminDelOrder} from "../../../api/order";
  ...
  export default {
    ...
    data() {
      return {
        ...
        operatorList: [
          {
            name: "黄龙",
            operateTime: '2021-04-25',
            orderStatus: '发货',
            logisticsStatus: '发货',//发货状态
            remark: "",//备注
          }
        ],
        order: {
    ...
    methods: {
      ...
      DelOrder() {
        ...
        reqAdminDelOrder(id).then(response => {
          if (response.code == 200) {
            this.$message({
